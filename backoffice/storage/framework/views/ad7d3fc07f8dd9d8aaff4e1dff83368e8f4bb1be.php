...
<head>
    ...
    <link href="<?php echo e(asset('dashboard/assets/css/paper-dashboard.css?v=2.0.0')); ?>" rel="stylesheet" />

    <link href="<?php echo e(asset('dashboard/assets/datatable/dataTables.bootstrap4.min.css')); ?>" rel="stylesheet" />

    <!-- <link href="<?php echo e(asset('dashboard/assets/datatable/rowReorder.dataTables.min.css')); ?>" rel="stylesheet" /> -->
    <link href="<?php echo e(asset('dashboard/assets/datatable/responsive.dataTables.min.css')); ?>" rel="stylesheet" />
    ...
    <link href="<?php echo e(asset('css/style-modern.css')); ?>?v=<?php echo e(time()); ?>" rel="stylesheet">
...
<body class="">
    ...
    <div style="position:fixed;top:0;left:0;right:0;z-index:100001;background:#e74c3c;color:#fff;text-align:center;padding:8px 16px;font-size:14px;font-weight:600;display:flex;align-items:center;justify-content:center;gap:12px;">
        <span><i class="fa fa-exclamation-triangle"></i> กำลังเข้าสู่ระบบแทน: <?php echo e(Auth::user()->name); ?> (<?php echo e(Auth::user()->customerno); ?>)</span>
        <a href="<?php echo e(route('users.stop-impersonate')); ?>" style="background:#fff;color:#e74c3c;padding:4px 16px;border-radius:4px;text-decoration:none;font-weight:700;font-size:13px;">
    ...
    <script src="<?php echo e(asset('dashboard/assets/js/paper-dashboard.min.js?v=2.0.0')); ?>"></script>

    <script src="<?php echo e(asset('dashboard/assets/datatable/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dashboard/assets/datatable/dataTables.bootstrap4.min.js')); ?>"></script>
    <!-- <script src="<?php echo e(asset('dashboard/assets/datatable/dataTables.rowReorder.min.js')); ?>"></script> -->
    <script src="<?php echo e(asset('dashboard/assets/datatable/dataTables.responsive.min.js')); ?>"></script>

    <!-- Paper Dashboard DEMO methods, don't include it in your project! -->
    <script src="<?php echo e(asset('dashboard/assets/demo/demo.js')); ?>"></script>
    <!-- Scripts -->
    ...
    <script>
        ...
        function showAmphoes(province = "#province", distrinct = "#distrinct") {
            ...
            let url = "<?php echo e(url('/api/amphoes')); ?>?province=" + input_province.value;
            console.log(url);
        ...
        function showTambons(province = "#province", distrinct = "#distrinct", subdistrinct = "#subdistrinct") {
            let input_province = document.querySelector(province);
            let input_amphoe = document.querySelector(distrinct);
            let url = "<?php echo e(url('/api/tambons')); ?>?province=" + input_province.value + "&amphoe=" + input_amphoe.value;
            console.log(url);
            // if(input_province.value == "") return;
        ...
        function showZipcode(province = "#province", distrinct = "#distrinct", subdistrinct = "#subdistrinct", postcode = "#postcode") {
            ...
            let input_amphoe = document.querySelector(distrinct);
            let input_tambon = document.querySelector(subdistrinct);
            let url = "<?php echo e(url('/api/zipcodes')); ?>?province=" + input_province.value + "&amphoe=" + input_amphoe.value +
...
</html><?php /**PATH C:\skjtrack\backoffice\resources\views/layouts/app.blade.php ENDPATH**/ ?>