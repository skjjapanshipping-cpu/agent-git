                    ...
                    <div class="card">
                        ...
                        <div class="body">
                           <form id="form_validation" method="POST" action="{{ route('users.update',$user->id) }}">
                            ...
                            <hr>
                            <a href="{{ route('users.impersonate', $user->id) }}" class="btn btn-warning btn-sm" onclick="return confirm('เข้าสู่ระบบแทน {{ $user->name }} ?')">
                                <i class="fa fa-sign-in"></i> เข้าสู่ระบบแทน {{ $user->name }}
                            </a>
                            @endif
                        </div>
                    </div>
