#!/usr/bin/env python3
"""
Apply same recipient dropdown changes to frontend (customer-facing) My Shipping:
1. Add (รับเอง) prefix when delivery_type_id=1
2. Move รับเอง entries to bottom of list
"""

path = '/var/www/vhosts/skjjapanshipping.com/backoffice/app/Http/Controllers/CustomerShippingViewController.php'
...
if old in content:
    ...
    with open(path, 'w') as f:
        f.write(content)
    print('Done - frontend recipient dropdown patched')
else:
